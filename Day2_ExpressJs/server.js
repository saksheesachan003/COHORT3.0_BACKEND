...
// calls express function and store in app
const app = express();

// middleware from accepting data from frontend
...
app.post("/create", (req, res) => {
  // Getting data which pass through frontend
...
//   if(req.url === "/carts") {
//     res.end("You are in cart's page....")
//   }
// });
